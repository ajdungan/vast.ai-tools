...
class Database:
    ...
    def insert_machine(self, time, data):
        ...
        query = "INSERT INTO machine (time, machine_id, account_credit, reliability, rentals_stored, rentals_on_demand, rentals_bid, earn_hour) VALUES(%s, %s, %s, %s, %s, %s, %s, %s)"
        values = (time, settings.VAST_MACHINE_ID, data['account_credit'], data['reliability'], data['rentals_stored'], data['rentals_on_demand'], data['rentals_bid'], data['earn_hour'])
        self.exec(query, values)
